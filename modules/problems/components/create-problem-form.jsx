...
const CodeEditor = ({ value, onChange, language = "javascript" }) => {
  ...
  return (
    <div className="bg-slate-950 border rounded-md text-slate-50">
      <div className="bg-slate-800 px-4 py-2 border-b font-mono text-sm">
        {language}
      </div>
                      ...
                      <div className="gap-6 grid grid-cols-1 md:grid-cols-2">
                        <div>
                          ...
                          <Textarea
                            ...
                            className="mt-2 min-h-24 font-mono resize-y"
                          />
                      ...
                      <div className="gap-6 grid grid-cols-1 md:grid-cols-2">
                        <div>
                          ...
                          <Textarea
                            ...
                            className="mt-2 min-h-20 font-mono resize-y"
                          />
